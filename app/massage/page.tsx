  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                className="favourite-gradient text-white hover:opacity-90 transition-all duration-300 px-8 py-4 text-lg"
              >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-playfair favourite-burgundy mb-6">Pourquoi Choisir favourite Massage ?</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center animate-slide-up" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full favourite-gradient mb-4">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-playfair favourite-burgundy mb-6">Nos Services</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            {services.map((service, index) => (
              <Card key={index} className="hover-lift border-0 shadow-lg overflow-hidden animate-slide-up" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="relative">
                  ...
                  />
                  {service.popular && (
                    <Badge className="absolute top-3 right-3 favourite-gradient text-white">
                      Populaire
                    </Badge>
                  )}
                </div>
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold favourite-burgundy">{service.price}</div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      {service.benefits.map((benefit, i) => (
                        <li key={i} className="flex items-center">
                          <div className="w-2 h-2 favourite-gradient rounded-full mr-2"></div>
                          {benefit}
                        </li>
                      ))}
                    </ul>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[var(--favourite-burgundy)] to-[var(--favourite-light-burgundy)]">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                className="bg-white text-[var(--favourite-burgundy)] hover:bg-gray-100 transition-colors duration-300 px-8 py-4 text-lg font-semibold"
              >
                <Calendar className="mr-2" size={20} />
                Réserver en Ligne
              </Button>
