...
export default function StoreSection() {
  return (
    <section id="store" className="py-20 relative overflow-hidden">
      {/* Luxury Background */}
      <div className="absolute inset-0 favourite-luxury-gradient-light opacity-30"></div>
      <div className="absolute inset-0 bg-gradient-to-br from-white/90 via-transparent to-white/70"></div>

      <div className="container mx-auto px-4 relative z-10">
        {/* Header */}
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-playfair favourite-burgundy mb-6">
            Nos Services
          </h2>
        ...
        {/* Categories */}
        <div className="mb-16">
          <h3 className="text-3xl font-playfair text-center mb-12 favourite-burgundy">Types de Services</h3>
        ...
        {/* Featured Products */}
        <div className="mb-16">
          <h3 className="text-3xl font-playfair text-center mb-12 favourite-burgundy">Services Populaires</h3>
                ...
                <div className="relative">
                  ...
                  <Badge
                    className={`absolute top-3 left-3 text-xs font-medium px-2 py-1 rounded-full ${
                      ...
                      product.badge === 'Nouveau' ? 'bg-[var(--favourite-burgundy)] text-white' :
                  ...
                  <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-sm rounded-full px-2 py-1">
                    <span className="text-[var(--favourite-burgundy)] font-bold text-sm">{product.price}</span>
                  </div>
                </div>
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-[var(--favourite-burgundy)] text-white px-3 py-1 rounded-full text-xs font-medium">
                      Commander
                    </button>
                  </div>
                </CardContent>
        ...
        <div className="text-center">
          <div className="favourite-luxury-gradient-dark rounded-2xl p-8 text-white luxury-shadow-dark relative overflow-hidden">
