  ...
  return (
    <section ref={heroRef} id="accueil" className="relative h-screen overflow-hidden pt-14 sm:pt-16 md:pt-18 mb-0">
      ...
      <button
        ...
        className="absolute left-6 top-1/2 transform -translate-y-1/2 z-10 p-4 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--favourite-gold)]"
      >
      ...
      <button
        ...
        className="absolute right-6 top-1/2 transform -translate-y-1/2 z-10 p-4 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--favourite-gold)]"
      >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-3 z-10" role="tablist" aria-label="Sélecteur d'images">
        {heroImages.map((_, index) => (
          <button
            ...
            className={`w-4 h-4 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--favourite-gold)] ${
      ...
      <div className="relative z-10 h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] md:h-[calc(100vh-4.5rem)] flex items-center justify-center py-4 sm:py-8">
        <div className={`text-center text-white max-w-5xl mx-auto px-4 transition-all duration-1000 ${
          ...
          <div className={`inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-6 py-2 mb-8 transition-all duration-700 delay-300 ${
            ...
            <Award className="text-[var(--favourite-gold)] w-4 h-4" />
            <span className="text-sm font-medium tracking-wide">Centre de Bien-être Premium</span>
            <div className="flex space-x-1">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-3 h-3 text-[var(--favourite-gold)] fill-current" />
              ))}
            </div>
          </div>
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center transition-all duration-1000 delay-1300 ${
            ...
            <Button
              ...
              className="group favourite-luxury-gradient-dark text-white hover:opacity-90 transition-all duration-500 px-10 py-5 text-lg hover-lift luxury-shadow rounded-full relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-[var(--favourite-gold)]"
            >
            ...
            <Button
              onClick={() => window.location.href = '/favourite-store'}
              size="lg"
              variant="outline"
              aria-label="Visiter notre boutique en ligne favourite Store"
              className="group luxury-backdrop border-2 border-white/40 text-white hover:bg-white/20 hover:border-[var(--favourite-gold)] transition-all duration-500 px-10 py-5 text-lg hover-lift luxury-border rounded-full relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-[var(--favourite-gold)]"
            >
              <span className="relative z-10 flex items-center space-x-2">
                <Heart className="w-5 h-5 group-hover:animate-pulse transition-transform duration-500" />
                <span>Visiter favourite Store</span>
              </span>
              <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[var(--favourite-gold)]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </Button>
          </div>
        </div>
      </div>
