...
const testimonials = [
  {
    ...
    content: 'favourite est exceptionnelle ! Ses massages m\'ont aidée à retrouver sérénité et bien-être. Je recommande vivement ses services.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Le drainage lymphatique chez favourite a transformé ma routine bien-être. Professionnalisme et douceur au rendez-vous.',
    rating: 5,
  ...
  },
  {
    name: 'Wahid Habibou',
    role: 'Maman Active',
    content: 'Un moment de détente absolue ! favourite sait exactement comment soulager les tensions. Une vraie professionnelle.',
    rating: 5,
...
export default function StatsTestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-gray-50 via-white to-[var(--favourite-gold-light)]/20 relative overflow-hidden mt-0">
      {/* Background Decorations */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-10 w-32 h-32 bg-[var(--favourite-burgundy)] rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-[var(--favourite-gold)] rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="inline-flex items-center space-x-2 bg-[var(--favourite-burgundy)]/10 rounded-full px-6 py-2 mb-6">
            <Award className="w-5 h-5 text-[var(--favourite-burgundy)]" />
            <span className="text-[var(--favourite-burgundy)] font-medium">Excellence & Confiance</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-playfair font-light text-gray-800 mb-4">
            Nos <span className="text-[var(--favourite-burgundy)]">Résultats</span> Parlent
          </h2>
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="mb-3">
                ...
                <span className="text-xl font-bold text-[var(--favourite-burgundy)]">{stat.suffix}</span>
              </div>
        ...
        <div className={`transition-all duration-1000 delay-800 ${
          ...
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-playfair font-light text-gray-800 mb-4">
              Ce que disent nos <span className="text-[var(--favourite-burgundy)]">Clientes</span>
            </h3>
              ...
              >
                ...
                <div className="flex mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 text-[var(--favourite-gold)] fill-current" />
                  ))}
                </div>
                ...
                <div className="flex items-center text-[var(--favourite-burgundy)]">
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-1400 ${
          ...
          <div className="glass-effect rounded-2xl p-8 max-w-2xl mx-auto">
            <Heart className="w-12 h-12 text-[var(--favourite-burgundy)] mx-auto mb-4 animate-pulse" />
            <h3 className="text-2xl font-playfair font-light text-gray-800 mb-4">
              Rejoignez nos clients satisfaits
            </h3>
            <p className="text-gray-600 mb-6">
              Réservez votre séance et découvrez pourquoi favourite est le choix de confiance pour votre bien-être
            </p>
            <button
              onClick={() => {
              ...
              className="favourite-luxury-gradient-dark text-white px-8 py-4 rounded-full font-semibold hover:opacity-90 transition-all duration-300 hover:scale-105 luxury-shadow"
            >
              Réserver Maintenant
            </button>
          </div>
