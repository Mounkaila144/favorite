        ...
        <div className={`relative flex justify-between items-center transition-all duration-500 ${
          ...
          <div className="flex items-center group cursor-pointer relative overflow-hidden rounded-xl px-3 py-2 glass-effect hover:glass-effect-dark transition-all duration-700 hover:scale-105 logo-container animate-fade-in-up" onClick={() => window.location.href = '/'}>
            ...
            <div className="relative mr-3 group-hover:scale-110 transition-transform duration-700">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#ed9aa4] via-[#e47987] to-[#d85a6b] flex items-center justify-center luxury-shadow group-hover:shadow-2xl transition-all duration-500 ring-2 ring-[#fbdde1]/50 group-hover:ring-[#f7bbc2]/80">
              ...
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#f7bbc2] via-[#ed9aa4] to-[#e47987] opacity-0 group-hover:opacity-70 transition-opacity duration-700 blur-md animate-gradient-x"></div>
            ...
            <div className="relative z-10">
              <h1 className={`font-bold transition-all duration-500 group-hover:scale-102 ${
                ...
                <span className="bg-gradient-to-r from-[#e47987] via-[#d85a6b] to-[#c43e50] bg-clip-text text-transparent font-playfair group-hover:scale-105 transition-transform duration-500 animate-gradient-x">
                  favourite
                </span>
                <span className={`ml-2 font-light group-hover:text-[#ed9aa4] transition-colors duration-300 relative ${
                  ...
                  {/* Underline effect */}
                  <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#e47987] to-[#f7bbc2] group-hover:w-full transition-all duration-500"></div>
                </span>
              </h1>
            ...
            <div className="absolute bottom-1 left-1 w-1.5 h-1.5 bg-gradient-to-tr from-[#f7bbc2] to-[#e47987] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 animate-pulse"></div>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            <button
              ...
              className={`group nav-link-hover px-4 py-2 transition-all duration-500 font-medium rounded-lg relative overflow-hidden ${
                activeSection === 'accueil'
                  ? 'text-white bg-gradient-to-r from-[#e47987] to-[#d85a6b] luxury-shadow'
                  : variant === 'light'
            ...
            >
              ...
              {activeSection !== 'accueil' && (
                <div className="absolute inset-0 bg-gradient-to-r from-[#e47987]/20 to-[#ed9aa4]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              )}
            </button>
            <button
            ...
            <nav className="flex flex-col space-y-2">
              <button
                ...
                className={`text-left transition-all duration-300 py-3 px-4 rounded-lg font-medium ${
                  variant === 'light'
                    ? 'text-gray-800 hover:text-[#e47987] hover:bg-gray-100'
