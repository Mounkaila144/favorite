        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 p-4">
            <div className="flex items-center space-x-2">
              <ShoppingCart className="text-[var(--favourite-burgundy)]" size={24} />
                ...
                {items.map((item) => (
                  <div key={item.id} className="flex items-center space-x-3 bg-gray-50 rounded-lg p-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[var(--favourite-burgundy)] font-semibold">
                        {item.price}
                      </p>
          ...
          {items.length > 0 && (
            <div className="border-t border-gray-200 p-4 space-y-3">
              ...
              <Button
                ...
                className="w-full favourite-luxury-gradient-dark text-white hover:opacity-90 transition-all duration-300 luxury-shadow"
              >
